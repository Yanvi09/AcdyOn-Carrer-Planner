function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-primary-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Your goal becomes a route.</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="bg-primary-card border border-border rounded-xl p-6 hover:border-primary-cyan/30 transition-all group-hover:scale-[1.02]">
                <div className="text-primary-cyan text-4xl font-bold mb-4 opacity-50">
                  {step.number}
                </div>
