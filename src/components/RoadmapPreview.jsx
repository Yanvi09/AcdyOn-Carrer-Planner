  ...
  const roadmapSteps = [
    { 
      ...
      details: {
        ...
        skills: ['Python', 'Problem Solving', 'Git Basics', 'Command Line']
      }
    },
    { 
      number: '02', 
      ...
      details: {
        ...
        skills: ['DSA', 'APIs', 'Databases', 'Backend Development']
      }
    },
    { 
      number: '03', 
      ...
      details: {
        title: 'Build & Ship',
        skills: ['Real Projects', 'Git', 'Deployment', 'Testing']
      }
    },
    { 
      number: '04', 
      ...
      details: {
        ...
        skills: ['Resume', 'System Design Basics', 'Mock Interviews', 'Practice']
      }
    },
    { 
      number: '05', 
      ...
      details: {
        ...
        skills: ['Targeted Prep', 'Behavioral Questions', 'Technical Rounds', 'Negotiation']
      }
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              {roadmapSteps.map((step) => (
                <div 
                  ...
                  className={`flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-lg bg-primary-cardLight border border-border cursor-pointer transition-all hover:border-primary-cyan/50 ${
                    selectedPhase?.number === step.number ? 'border-primary-blue bg-primary-blue/10' : ''
                  }`}
                >
          ...
          <div className="bg-primary-card border border-border rounded-xl sm:rounded-2xl p-4 sm:p-8">
            {selectedPhase ? (
              <div>
                <h3 className="text-text-main font-semibold text-base sm:text-lg mb-4 sm:mb-6">
                  {selectedPhase.details.title}
                </h3>
                
                <div className="mb-4">
                  <p className="text-text-muted text-xs sm:text-sm mb-2 sm:mb-3">Learn</p>
                  <div className="space-y-1.5 sm:space-y-2">
                    {selectedPhase.details.skills.map((skill) => (
                      <div 
                        key={skill}
                ...
                <div className="pt-3 sm:pt-4 border-t border-border">
                  <p className="text-text-muted text-xs">
                    Click a roadmap phase to see details
                  </p>
                </div>
              </div>
            ) : (
